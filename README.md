...
| File | What it is |
|---|---|
| `mpef-analyzer-offline.html` | **The app.** Engine v1.3. Open it in any browser — no build, no install, no network. |
...
renders **MPI 75 · Productive**. See `README.txt` for end-user
